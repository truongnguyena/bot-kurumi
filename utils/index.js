...
module.exports.getYoutube = async function(t, e, i) {
    ...
    if ("search" == e) {
      ...
      if (!t) { console.log("Thiếu dữ liệu"); return []; }
      return (await e.GetListByKeyword(t, !1, 6)).items;
    }
    if ("getLink" == e) {
...
module.exports.isBotAdmin = adminGuard.isBotAdmin;
module.exports.isImmune = adminGuard.isImmune;
module.exports.getAdminContactLine = adminGuard.getAdminContactLine;
module.exports.clearAdminSanctions = adminGuard.clearAdminSanctions;
