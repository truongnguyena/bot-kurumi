module.exports = function ({ api, models }) {
  ...
  (async function () {
    try {
      ...
      for (const dataU of users) {
        ...
        if (dataU.data && dataU.data.banned == 1 && !adminGuard.isImmune(idUsers)) {
      ...
      require('../utils/adminGuard').clearAdminSanctions();
    } catch (error) {
  ...
  logger(" Kurumi Bot | Admin: kurumi2004 | fb.com/kurumi2004", "[ BOT INFO ]");
  logger("┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓", "[ BOT INFO ]");
  ...
  logger(` NAME BOT: ${global.config.BOTNAME || "Kurumi Bot"}`, "[ BOT INFO ]");
  logger("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛", "[ BOT INFO ]");
  /////////////////////////////////////////////
...
////////////////
/// Kurumi Bot — Admin: https://www.facebook.com/kurumi2004/
